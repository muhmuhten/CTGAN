...
from ctgan.synthesizers.dp_ctgan import CTGAN, Generator, Discriminator
...
class ADPCTGAN(CTGAN):
    ...
    def __init__(self, embedding_dim=128, generator_dim=(256, 256), discriminator_dim=(256, 256),
        ...
        super(ADPCTGAN, self).__init__(embedding_dim, generator_dim, discriminator_dim,
