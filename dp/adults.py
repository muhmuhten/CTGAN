...
from ctgan import load_demo, CTGAN, DPCTGAN, ADPCTGAN
...
if __name__ == '__main__':
    ...
    dpctgan = DPCTGAN(verbose=True, target_epsilon=3)
    print(dpctgan.get_config())
    dpctgan.fit(data, discrete_columns)
    dpctgan.plot_losses()
    #
    # adpctgan = ADPCTGAN(verbose=True, private=True, target_epsilon=3)
